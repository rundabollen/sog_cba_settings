...
force ace_dragging_weightCoefficient = 0; //Modifies weight limit calculations. Set to 0 to ignore. Value goes from 0.0 -> 2.0
...
force ace_medical_playerDamageThreshold = 3; //Players have 500% health pool
